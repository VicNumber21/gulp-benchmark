...
module.exports = function () {
  return function (data) {
    ...
    if (passed.length === 0) {
      ...
      gutil.log(util.indent(1) + 'Only test passed: ' + Benchmark.prototype.toString.call(passed[0]));
    }
    else {
      var first = passed[0];
      var second = passed[1];
      ...
      gutil.log(util.indent(1) + 'Fastest test is ' + first.name + ' at ' + timesStr + 'x faster than ' + second.name);
    }
  };
};
